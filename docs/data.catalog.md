...
The **Gold Layer** is the business-level data representation of the warehouse, structured to support analytical and reporting use cases. It consists of **dimension tables** and **fact tables** for specific business metrics, built on top of the Silver Layer using conformed, cleansed, and enriched data.

This layer follows a **star schema** design:

- `gold.dim_customers` and `gold.dim_products` → Dimension tables
